...
The scRNA-seq data used in this project is available under the GEO accession GSE208195. The metadata for the hEE object is supplied as Supplementary Table 6. The reclustered in vivo reference and the CellTypist classification scores are available in this repository under "processed_data".
