...
ref_a <- AverageExpression(ref, features = VariableFeatures(data), assays = "RNA", group.by = "Pedroza.annotation")$RNA
...
edfig3f_data <- edfig3f_data[as.character(unique(ref$Pedroza.annotation)), as.character(unique(data$Cell.type))]
